...
// The Oklab/OKLCH maths lives in lib/oklab.js: gen-pwa-icons.js performs the
// hero's `color-mix(in oklab, ...)` for the PWA screenshot, and two copies of
// colour maths is the drift this repo keeps paying for.
const {
    oklabToHex,
    oklchToHex,
    hexToOklab,
